            ...
            var options = {
                ...
                onValueChanged: function (e) {
                    ...
                    for (var _i = 0, _a = e.value; _i < _a.length; _i++) {
                        ...
                        si += '<span>' + WUX.buildIcon(WUX.WIcon.FILE_O) + ' &nbsp;<strong>' + WUX.TXT.NAME + '</strong>: ' + f.name + ' &nbsp;';
                        si += '<strong>' + WUX.TXT.SIZE + '</strong>: ' + f.size + ' byte &nbsp;';
                        si += '<strong>' + WUX.TXT.TYPE + '</strong>: ' + f.type + ' &nbsp;';
                        si += '<strong>' + WUX.TXT.LAST_MOD + '</strong>: ' + WUX.formatDateTime(lmd, true) + '</span>';
                        si += '</div>';
...
(function (WUX) {
    ...
    var MSG = (function () {
        ...
        MSG.INVALID_DATE = 'Data non ammessa.';
    ...
    var ICO = (function () {
        ...
        ICO.TRUE = WUX.WIcon.CHECK_SQUARE_O;
        ICO.FALSE = WUX.WIcon.SQUARE_O;
        ICO.CLOSE = WUX.WIcon.TIMES;
        ICO.OK = WUX.WIcon.CHECK;
        ICO.CALENDAR = WUX.WIcon.CALENDAR;
        ICO.AGGREGATE = WUX.WIcon.CHAIN;
        ICO.NEW = WUX.WIcon.PLUS_SQUARE_O;
        ICO.EDIT = WUX.WIcon.EDIT;
        ICO.OPEN = WUX.WIcon.EDIT;
        ICO.DELETE = WUX.WIcon.TRASH;
        ICO.DETAIL = WUX.WIcon.FILE_TEXT_O;
        ICO.SAVE = WUX.WIcon.CHECK;
        ICO.FIND = WUX.WIcon.SEARCH;
        ICO.FIND_DIFF = WUX.WIcon.SEARCH_MINUS;
        ICO.FIND_PLUS = WUX.WIcon.SEARCH_PLUS;
        ICO.FORCE = WUX.WIcon.CHECK_CIRCLE;
        ICO.FORCE_ALL = WUX.WIcon.CHECK_CIRCLE_O;
        ICO.SEARCH = WUX.WIcon.SEARCH;
        ICO.CANCEL = WUX.WIcon.UNDO;
        ICO.RESET = WUX.WIcon.TIMES_CIRCLE;
        ICO.PRINT = WUX.WIcon.PRINT;
        ICO.PREVIEW = WUX.WIcon.SEARCH_PLUS;
        ICO.EXPORT = WUX.WIcon.SHARE_SQUARE_O;
        ICO.IMPORT = WUX.WIcon.SIGN_IN;
        ICO.FILE = WUX.WIcon.FILE_O;
        ICO.HELP = WUX.WIcon.QUESTION_CIRCLE;
        ICO.VIEW = WUX.WIcon.FILE_TEXT_O;
        ICO.ENABLE = WUX.WIcon.THUMBS_O_UP;
        ICO.DISABLE = WUX.WIcon.THUMBS_O_DOWN;
        ICO.ADD = WUX.WIcon.PLUS;
        ICO.APPLY = WUX.WIcon.CHECK;
        ICO.REMOVE = WUX.WIcon.MINUS;
        ICO.REFRESH = WUX.WIcon.REFRESH;
        ICO.UNDO = WUX.WIcon.UNDO;
        ICO.SETTINGS = WUX.WIcon.COG;
        ICO.OPTIONS = WUX.WIcon.CHECK_SQUARE;
        ICO.PASSWORD = WUX.WIcon.UNDO;
        ICO.COPY = WUX.WIcon.COPY;
        ICO.CUT = WUX.WIcon.CUT;
        ICO.PASTE = WUX.WIcon.PASTE;
        ICO.FORWARD = WUX.WIcon.ANGLE_DOUBLE_RIGHT;
        ICO.BACKWARD = WUX.WIcon.ANGLE_DOUBLE_LEFT;
        ICO.NEXT = WUX.WIcon.FORWARD;
        ICO.PREVIOUS = WUX.WIcon.BACKWARD;
        ICO.CONFIRM = WUX.WIcon.CHECK;
        ICO.FILTER = WUX.WIcon.FILTER;
        ICO.SEND = WUX.WIcon.SEND;
        ICO.SEND_EMAIL = WUX.WIcon.ENVELOPE_O;
        ICO.WAIT = WUX.WIcon.COG;
        ICO.WORK = WUX.WIcon.COG;
        ICO.CONFIG = WUX.WIcon.COG;
        ICO.LEFT = WUX.WIcon.ARROW_CIRCLE_LEFT;
        ICO.RIGHT = WUX.WIcon.ARROW_CIRCLE_RIGHT;
        ICO.SELECT_ALL = WUX.WIcon.TH_LIST;
        ICO.REWORK = WUX.WIcon.REFRESH;
        ICO.PUSH = WUX.WIcon.TRUCK;
        ICO.AHEAD = WUX.WIcon.ANGLE_DOUBLE_RIGHT;
        ICO.SUSPEND = WUX.WIcon.TOGGLE_OFF;
        ICO.RESUME = WUX.WIcon.RECYCLE;
        ICO.PAIRING = WUX.WIcon.RANDOM;
        ICO.CHECK = WUX.WIcon.CHECK_SQUARE_O;
        ICO.EVENT = WUX.WIcon.BOLT;
        ICO.MESSAGE = WUX.WIcon.ENVELOPE_O;
        ICO.USER = WUX.WIcon.USER_O;
        ICO.GROUP = WUX.WIcon.USERS;
        ICO.TOOL = WUX.WIcon.WRENCH;
        ICO.DEMOGRAPHIC = WUX.WIcon.ADDRESS_CARD;
        ICO.DOCUMENT = WUX.WIcon.FILE_TEXT_O;
        ICO.LINKS = WUX.WIcon.CHAIN;
        ICO.WARNING = WUX.WIcon.WARNING;
        ICO.INFO = WUX.WIcon.INFO_CIRCLE;
        ICO.CRITICAL = WUX.WIcon.TIMES_CIRCLE;
        return ICO;
    }());
    WUX.ICO = ICO;
})(WUX || (WUX = {}));
