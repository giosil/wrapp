...
this._init&&(this.root.empty(),this.root.next("span").remove()),this.root.select2(e),this.updateState(this.state),e?e.data&&(this.count=t.WUtil.size(e.data)):this.count=0,this._init||(this.$cb=this.root.parent().find('span[role="combobox"]').first(),this.$cb.length?this.$cb.on("focus",function(t){if(null!=t.relatedTarget)return i.dontOpen?void(i.dontOpen=!1):void(i.openOnFocus&&setTimeout(function(){if(i.multiple){if(i.$cb&&i.$cb.length){var t=i.$cb.find("input.select2-search__field").first()
