...
return!n||n.length<2?[e,t.trim(),i]:(e+=n[0],2==n.length?[e,n[1],""]:(i+=n[2],[e,n[1],i]))}function f(t){if(t instanceof M){var e=t.name,i=t.id
...
if(e instanceof M){var i=e.rootTag
...
return i}function v(t){var e=m(t),i={}
if(!e)return i
for(var n=e.split(";"),o=0,r=n;o<r.length;o++){var s=r[o],a=s.split(":")
a.length<2||(i[a[0].trim()]=a[1].trim())}return i}function m(t){var e=""
...
s&&("string"==typeof s?(o||(i+=m(n),n={},o=!0),s.indexOf(":")>0&&(i+=s,";"!=s.charAt(s.length-1)&&(i+=";"))):($.extend(n,s),o=!1))}return o||(i+=m(n)),i}function C(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
if(!t||!t.length)return""
for(var i="",n=0;n<t.length;n++){var o=t[n]
if(o){var r="string"==typeof o?o:o.n
r&&(r.indexOf(":")>0||(i+=r+" "))}}return i.trim()}function x(t){if(!t)return""
...
if(!t||!t.length)return""
var i=C.apply(void 0,t),n=w.apply(void 0,t),o=""
return i&&(o+=' class="'+i+'"'),n&&(o+=' style="'+n+'"'),o}function k(t,e){if(!t||!e)return t
for(var i=t.split(" "),n="",o=0,r=i;o<r.length;o++){var s=r[o]
s!=e&&(n+=s+" ")}return n.trim()}function W(t,e){if(!t||!e)return t
for(var i=t.split(" "),n=!1,o="",r=0,s=i;r<s.length;r++){var a=s[r]
a!=e?o+=a+" ":n=!0}return n?o.trim():o.trim()+" "+e}function D(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i]
if(!t||!e||!e.length)return t
if(t instanceof M)t.css.apply(t,e)
else if(t instanceof jQuery){if(!t.length)return t
var n=w.apply(void 0,e),o=C.apply(void 0,e)
o&&t.addClass(o),n&&t.css(v(n))}return t}function R(t,e,i,n,o,r){if(!t)return""
e||(e=""),i||(i="")
var s=r?' title="'+r+'"':""
...
$(e).val(i)}}else if(e instanceof M){if(void 0===i)return e.getState()
...
return e.indexOf("#")<0&&(e="#"+e),t.getContainer($(e))}if(e instanceof M){var n=e.getContext()
...
var e=[]
return e.push(t),e},e.toArrayNumber=function(t,i){if(t instanceof M&&(t=t.getState()),null==t)return[]
var n=[]
if(Array.isArray(t))for(var o=0,r=t;o<r.length;o++){var s=r[o],a=e.toNumber(s)
i&&!a||n.push(a)}else{var a=e.toNumber(t)
if(i&&!a)return n
n.push(a)}return n},e.toArrayString=function(t,i){if(t instanceof M&&(t=t.getState()),null==t)return[]
var n=[]
...
r.push(e.toNumber(l))}return r},e.toObject=function(t,e){return t instanceof M&&(t=t.getState()),null==t?e:"object"==typeof t?t:e},e.toString=function(i,n){return void 0===n&&(n=""),i instanceof M&&(i=i.getState()),null==i?n:"string"==typeof i?i:i instanceof Date?t.formatDate(i):"object"==typeof i&&void 0!=i.id?e.toString(i.id,n):Array.isArray(i)&&i.length?e.toString(i[0],n):""+i},e.toText=function(t,i){return void 0===i&&(i=""),e.toString(t,i).replace("<","&lt;").replace(">","&gt;")},e.toNumber=function(t,i){if(void 0===i&&(i=0),t instanceof M&&(t=t.getState()),null==t)return i
...
return isNaN(o)?i:o},e.toInt=function(t,i){if(void 0===i&&(i=0),t instanceof M&&(t=t.getState()),null==t)return i
...
return isNaN(o)?i:o},e.toIntTime=function(t,i){if(void 0===i&&(i=0),t instanceof M&&(t=t.getState()),null==t)return i
...
return!0}return!1},e.toBoolean=function(e,i){return void 0===i&&(i=!1),e instanceof t.WCheck&&(e=e.getProps()),e instanceof M&&(e=e.getState()),null==e?i:"boolean"==typeof e?e:"string"==typeof e&&e.length?"1YyTtSs".indexOf(e.charAt(0))>=0:!!i},e.toDate=function(t,e){if(t instanceof M&&(t=t.getState()),null==t)return e
...
return null==i?e:i}return e}return e},e.toCode=function(t,e){return void 0===e&&(e=""),t instanceof M&&(t=t.getState()),null==t?e:"string"==typeof t?t:"object"==typeof t&&void 0!=t.code?t.code:Array.isArray(t)&&t.length?t.length>1?t[1]:t[0]:t},e.toDesc=function(t,i){return void 0===i&&(i=""),t instanceof M&&(t=t.getState()),null==t?i:"string"==typeof t?t:"object"==typeof t&&void 0!=t.text?e.toString(t.text,i):Array.isArray(t)&&t.length?e.toString(t[t.length-1],i):e.toString(t,i)},e.getNumber=function(t,i,n){return e.toNumber(e.getValue(t,i,n))},e.getInt=function(t,i,n){return e.toInt(e.getValue(t,i,n))},e.getString=function(i,n,o,r){var s=e.getValue(i,n)
...
return l>12&&h++,h},e}()
t.WUtil=F,t.getId=e,t.firstSub=i,t.lastSub=n,t.getComponent=o,t.getRootComponent=r,t.setProps=s,t.getProps=a,t.setState=l,t.getState=h,t.newInstance=u,t.same=d,t.parse=p,t.divide=c,t.str=f,t.getTagName=g,t.match=y,t.hashCode=b,t.styleObj=v,t.style=m,t.addStyle=_,t.css=w,t.cls=C,t.attributes=x,t.ul=S,t.ol=T,t.buildCss=O,t.removeClass=k,t.toggleClass=W,t.setCss=D,t.buildIcon=R,t.build=I,t.addWrapper=E,t.val=A,t.getContainer=L,t.openURL=U}(WUX||(WUX={}))
var WUX
...
return n?t.formatDay(r.getDay(),o)+", "+l+"/"+a+"/"+r.getFullYear()+" "+h+":"+u+":"+d:l+"/"+a+"/"+r.getFullYear()+" "+h+":"+u+":"+d}return n?t.formatDay(r.getDay(),o)+", "+l+"/"+a+"/"+r.getFullYear()+" "+h+":"+u:l+"/"+a+"/"+r.getFullYear()+" "+h+":"+u}function v(t,e){if(void 0===e&&(e=!1),null==t)return""
...
return a+":"+l+":"+s}return a+":"+l}return""}function m(e,i,n,o){if(""===e||null==e)return""
...
return a<0&&(s+=",00"),a==s.length-2&&(s+="0"),null!=i&&0!=r?null!=o&&r<0?o.replace("$",s):i.replace("$",s):null!=n&&0==r?n.replace("$",s):s}function C(e,i,n,o){if(""===e||null==e)return""
...
s=u+h}return null!=i&&0!=r?null!=o&&r<0?o.replace("$",s):i.replace("$",s):null!=n&&0==r?n.replace("$",s):s}function x(t){return null==t?"":t?"S":"N"}function S(e){if(null==e)return""
...
return n>0&&n<13?n:0}function W(t){return t?(t=""+t,t=t.replace("À","A'").replace("È","E'").replace("Ì","I'").replace("Ò","O'").replace("Ù","U'"),t=t.replace("à","a'").replace("è","e'").replace("ì","i'").replace("ò","o'").replace("ù","u'"),t=t.replace("á","a`").replace("é","e`").replace("í","i`").replace("ó","o`").replace("ú","u`"),t=t.replace("€","E").replace("ª","a").replace("°","o")):""}function D(t){return t?(t=""+t,t=t.replace("A'","À").replace("E'","È").replace("I'","Ì").replace("O'","Ò").replace("U'","Ù"),t=t.replace("a'","à").replace("e'","è").replace("i'","ì").replace("o'","ò").replace("u'","ù"),t=t.replace("a`","á").replace("e`","é").replace("i`","í").replace("o`","ó").replace("u`","ú"),t=t.replace(" pò"," po'")):""}function R(t){return t?(t=""+t,t=t.replace("&Agrave;","A'").replace("&Egrave;","E'").replace("&Igrave;","I'").replace("&Ograve;","O'").replace("&Ugrave;","U'"),t=t.replace("&agrave;","a'").replace("&egrave;","e'").replace("&igrave;","i'").replace("&ograve;","o'").replace("&ugrave;","u'"),t=t.replace("&aacute;","a`").replace("&eacute;","e`").replace("&iacute;","i`").replace("&oacute;","o`").replace("&uacute;","u`"),t=t.replace("&euro;","E").replace("&nbsp;"," ").replace("&amp;","&").replace("&gt;",">").replace("&lt;","<").replace("&quot;",'"')):""}function I(t){if(!t)return""
...
var M=function(){function t(){}return t.STICKY_CONTAINER="data-b2x-sticky-container",t.STICKY_ELEMENT='data-b2x-sticky-element data-b2x-sticky-element-z-index="3"',t.BOX_FILTER='data-b2x-sticky-element data-b2x-sticky-element-ignore-margin-bottom="true" data-b2x-sticky-element-z-index="3"',t}()
t.ATT=M
...
var N=function(){function t(){}return t.OK="OK",t.CLOSE="Chiudi",t.CANCEL="Annulla",t.ERR_DATE="Data non ammessa.",t}()
t.RES=N}(WUX||(WUX={}))
var WUX
...
case"b":g=g?"&check;":""
break
default:g instanceof Date&&(g=t.formatDate(g)),"boolean"==typeof g&&(g=g?"&check;":""),"number"==typeof g&&(g=t.formatNum2(g),y="text-right")}var v=void 0
v=0==d?this.col0Style?this.col0Style:this.colStyle:d==this.header.length-1&&this.colLStyle?this.colLStyle:this.colStyle,"string"==typeof v?v.indexOf("text-align")>0&&(y=""):v&&v.a&&(y="")
var m=this.widths&&this.widths.length>d?this.widths[d]:0,_=this.templates&&this.templates.length>d?this.templates[d]:void 0
if(_){var w=$("<td"+t.buildCss(v,y,{w:m})+"></td>")
_(w,{data:r,text:g}),s.append(w)}else if(t.WUtil.hasComponents(g))for(var C=t.WUtil.toArrayComponent(g),x=0,S=C;x<S.length;x++){var T=S[x],w=$("<td"+t.buildCss(v,y,{w:m})+"></td>")
s.append(w),T.mount(w)}else this.boldNonZero&&0!=g&&"0"!=g&&""!=g?s.append($("<td"+t.buildCss(v,y,{w:m})+"><strong>"+g+"</strong></td>")):s.append($("<td"+t.buildCss(v,y,{w:m})+">"+g+"</td>"))}if(this.header&&this.header.length>this.keys.length)for(var O=0;O<this.header.length-this.keys.length;O++)s.append($("<td"+t.buildCss(this.colStyle)+"></td>"))}},i}(t.WComponent)
t.WTable=f
...
if(d.labelCss){var b=t.cls(d.labelCss),v=t.style(d.labelCss)
b&&(g+=' class="'+b+'"'),v&&(g+=' style="'+v+'"')}else if(d.required){var b=t.cls(t.CSS.FIELD_REQUIRED),v=t.style(t.CSS.FIELD_REQUIRED)
b&&(g+=' class="'+b+'"'),v&&(g+=' style="'+v+'"'),y=" *"}if(d.id&&this.mapTooltips[d.id]?f.append($('<label for="'+d.id+'" title="'+this.mapTooltips[d.id]+'"'+g+">"+d.label+y+"</label>")):d.id?f.append($('<label for="'+d.id+'" title="'+d.label+'"'+g+">"+d.label+y+"</label>")):f.append($('<label title="'+d.label+'"'+g+">"+d.label+y+"</label>")),d.id&&this.mapLabelLinks[d.id])for(var m=0,_=this.mapLabelLinks[d.id];m<_.length;m++){var w=_[m],C=$('<span style="padding-left:8px;"></span>')
f.append(C),w.mount(C)}}switch(d.type){case t.WInputType.Blank:d.element=$(t.build("div",d.placeholder,d.style,d.attributes,d.id,d.classStyle))
break
case t.WInputType.Text:var x='<input type="text" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(x+="readonly "),0==d.enabled&&(x+="disabled "),d.style&&(x+=' style="'+t.style(d.style)+'"'),x+="/>",d.element=$(x)
break
...
if(d.attributes?(O+='<select name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '+d.attributes,(d.readonly||0==d.enabled)&&(O+=" disabled"),O+=">"):(O+='<select name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'"',(d.readonly||0==d.enabled)&&(O+="disabled"),O+=">"),d.options&&d.options.length>0)for(var k=0;k<d.options.length;k++){var W=d.options[k]
O+="string"==typeof W?"<option>"+W+"</option>":'<option value="'+W.id+'">'+W.text+"</option>"}O+="</select>",d.element=$(O)
break
...
null!=d.value&&""!=d.value&&(E='initial: "'+d.value+'" ,')
var A='<div id="cron_'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(A+="readonly "),0==d.enabled&&(A+="disabled "),A+=" ></div>",A+='<script type="text/javascript">$(document).ready(function() {',A+='$("#cron_'+d.id+'").cron({'+E+'onChange: function() {$("#'+d.id+'").val($(this).cron("value"));},useGentleSelect: true});',A+='});<\/script><input type="hidden" name="'+d.id+'" id="'+d.id+'" />',d.element=$(A)
break
...
null==d.value&&(d.value=""),this.root.append('<input type="hidden" name="'+d.id+'" id="'+d.id+'" value="'+d.value+'">')}if(this.footer&&this.footer.length>0){var M=t.style(this.footerStyle)
if(this.footerClass||(this.footerClass="col-md-12"),M=M?' style="'+M+'"':' style="text-align:right;"',this.footerSep)if("string"==typeof this.footerSep){var F=this.footerSep.charAt(0)
...
var N=$('<div class="row"></div>')
this.root.append(N)
var P=$('<div class="'+this.footerClass+'"'+M+"></div>")
N.append(P)
for(var H=0,V=this.footer;H<V.length;H++){var B=V[H]
"string"==typeof B&&B.length>0?P.append($(B)):B instanceof t.WComponent?B.mount(P):P.append(B)}}for(var G=this,j=0,z=this.dpids;j<z.length;j++){var X=z[j]
!function(i){var n=t.WUtil.getDate(G.minValues,i)
...
else for(var v=0,m=h;v<m.length;v++){var p=m[v]
...
a+="<span>"+t.buildIcon(t.WIcon.FILE_O)+" &nbsp;<strong>Name</strong>: "+r.name+" &nbsp;",a+="<strong>Size</strong>: "+r.size+" byte &nbsp;",a+="<strong>Type</strong>: "+r.type+" &nbsp;",a+="<strong>Last Mod.</strong>: "+t.formatDateTime(s,!0)+"</span>",a+="</div>",e.selectedFiles.append(a)}}}}
