var __spreadArrays=this&&this.__spreadArrays||function(){for(var t=0,e=0,i=arguments.length;e<i;e++)t+=arguments[e].length
for(var n=Array(t),o=0,e=0;e<i;e++)for(var r=arguments[e],s=0,a=r.length;s<a;s++,o++)n[o]=r[s]
return n},__extends=this&&this.__extends||function(){var t=function(e,i){return(t=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(t,e){t.__proto__=e}||function(t,e){for(var i in e)e.hasOwnProperty(i)&&(t[i]=e[i])})(e,i)}
return function(e,i){function n(){this.constructor=e}t(e,i),e.prototype=null===i?Object.create(i):(n.prototype=i.prototype,new n)}}()
...
return!n||n.length<2?[e,t.trim(),i]:(e+=n[0],2==n.length?[e,n[1],""]:(i+=n[2],[e,n[1],i]))}function f(t){if(t instanceof N){var e=t.name,i=t.id
...
if(e instanceof N){var i=e.rootTag
...
if(!t||!t.length)return""
var i=w.apply(void 0,t),n=C.apply(void 0,t),o=""
return i&&(o+=' class="'+i+'"'),n&&(o+=' style="'+n+'"'),o}function W(t,e){if(!t||!e)return t
for(var i=t.split(" "),n="",o=0,r=i;o<r.length;o++){var s=r[o]
s!=e&&(n+=s+" ")}return n.trim()}function E(t,e){if(!t||!e)return t
for(var i=t.split(" "),n=!1,o="",r=0,s=i;r<s.length;r++){var a=s[r]
a!=e?o+=a+" ":n=!0}return n?o.trim():o.trim()+" "+e}function I(t){for(var e=[],i=1;i<arguments.length;i++)e[i-1]=arguments[i]
if(!t||!e||!e.length)return t
if(t instanceof N)t.css.apply(t,e)
else if(t instanceof jQuery){if(!t.length)return t
var n=C.apply(void 0,e),o=w.apply(void 0,e)
o&&t.addClass(o),n&&t.css(m(n))}return t}function R(t,e,i,n,o,r){if(!t)return""
e||(e=""),i||(i="")
var s=r?' title="'+r+'"':""
return o=o?" "+o:"",t.indexOf(".")>0?e+'<img src="'+t+'"'+s+">"+i:!n||n<2?e+'<i class="fa '+t+o+'"'+s+"></i>"+i:(n>5&&(n=5),e+'<i class="fa '+t+" fa-"+n+"x"+o+'"'+s+"></i>"+i)}function D(e,i,n,o,r,s){e||(e="div")
var a,l
...
u&&(h+=" "+u),h+=">"
var d=c(i)
return h+=d[1],"input"==e?d[0]+h+d[2]:(h+="</"+e+">",d[0]+h+d[2])}function k(e,i,n,o){if(!e||!i)return e
...
$(e).val(i)}}else if(e instanceof N){if(void 0===i)return e.getState()
...
return e.indexOf("#")<0&&(e="#"+e),t.getContainer($(e))}if(e instanceof N){var n=e.getContext()
if(n){var o=n.closest(i)
if(o&&o.length)return o}return n}var o=e.parent().closest(i)
return o&&o.length?o:e.parent()}}function U(t,e,i,n){if(void 0===e&&(e=!0),void 0===i&&(i=!1),t){if(n&&"object"==typeof n){var o=""
...
for(var s=this.createEvent(t,r),a=0,l=this.handlers[t];a<l.length;a++){(0,l[a])(s)}}else this.root&&this.root.length&&(this.debug&&console.log("["+f(this)+"] trigger "+t+" on root="+f(this.root)),(e=this.root).trigger.apply(e,__spreadArrays([t],n)))
return this.internal&&(this.debug&&console.log("["+f(this)+"] trigger "+t+" on internal="+f(this.internal)),(i=this.internal).trigger.apply(i,__spreadArrays([t],n))),this}},e.prototype.unmount=function(){if(this.debug&&console.log("["+f(this)+"] unmount ctx="+f(this.context)+" root="+f(this.root),this.state,this.props),this.componentWillUnmount(),this.internal&&this.internal.unmount(),this.internal=void 0,this.root&&this.root.length&&this.root.remove(),this.root=void 0,this.id){var e=t.registry.indexOf(this.id)
...
if(Array.isArray(t)&&t.length)return t[0]instanceof N?t:[]
var e=[]
return t instanceof N&&e.push(t),e},e.hasComponents=function(t){return!!t&&(Array.isArray(t)&&t.length?t[0]instanceof N:t instanceof N)},e.toArray=function(t){if(t instanceof N&&(t=t.getState()),null==t)return[]
if(Array.isArray(t))return t
var e=[]
return e.push(t),e},e.toArrayNumber=function(t,i){if(t instanceof N&&(t=t.getState()),null==t)return[]
var n=[]
if(Array.isArray(t))for(var o=0,r=t;o<r.length;o++){var s=r[o],a=e.toNumber(s)
i&&!a||n.push(a)}else{var a=e.toNumber(t)
if(i&&!a)return n
n.push(a)}return n},e.toArrayString=function(t,i){if(t instanceof N&&(t=t.getState()),null==t)return[]
var n=[]
...
r.push(e.toNumber(l))}return r},e.toObject=function(t,e){return t instanceof N&&(t=t.getState()),null==t?e:"object"==typeof t?t:e},e.toString=function(i,n){return void 0===n&&(n=""),i instanceof N&&(i=i.getState()),null==i?n:"string"==typeof i?i:i instanceof Date?t.formatDate(i):"object"==typeof i&&void 0!=i.id?e.toString(i.id,n):Array.isArray(i)&&i.length?e.toString(i[0],n):""+i},e.toText=function(t,i){return void 0===i&&(i=""),e.toString(t,i).replace("<","&lt;").replace(">","&gt;")},e.toNumber=function(t,i){if(void 0===i&&(i=0),t instanceof N&&(t=t.getState()),null==t)return i
...
return isNaN(o)?i:o},e.toInt=function(t,i){if(void 0===i&&(i=0),t instanceof N&&(t=t.getState()),null==t)return i
...
return isNaN(o)?i:o},e.toIntTime=function(t,i){if(void 0===i&&(i=0),t instanceof N&&(t=t.getState()),null==t)return i
...
return!0}return!1},e.toBoolean=function(e,i){return void 0===i&&(i=!1),e instanceof t.WCheck&&(e=e.getProps()),e instanceof N&&(e=e.getState()),null==e?i:"boolean"==typeof e?e:"string"==typeof e&&e.length?"1YyTtSs".indexOf(e.charAt(0))>=0:!!i},e.toDate=function(t,e){if(t instanceof N&&(t=t.getState()),null==t)return e
...
return null==i?e:i}return e}return e},e.toCode=function(t,e){return void 0===e&&(e=""),t instanceof N&&(t=t.getState()),null==t?e:"string"==typeof t?t:"object"==typeof t&&void 0!=t.code?t.code:Array.isArray(t)&&t.length?t.length>1?t[1]:t[0]:t},e.toDesc=function(t,i){return void 0===i&&(i=""),t instanceof N&&(t=t.getState()),null==t?i:"string"==typeof t?t:"object"==typeof t&&void 0!=t.text?e.toString(t.text,i):Array.isArray(t)&&t.length?e.toString(t[t.length-1],i):e.toString(t,i)},e.getNumber=function(t,i,n){return e.toNumber(e.getValue(t,i,n))},e.getInt=function(t,i,n){return e.toInt(e.getValue(t,i,n))},e.getString=function(i,n,o,r){var s=e.getValue(i,n)
...
return l>12&&h++,h},e}()
t.WUtil=M,t.getId=e,t.firstSub=i,t.lastSub=n,t.getComponent=o,t.getRootComponent=r,t.setProps=s,t.getProps=a,t.setState=l,t.getState=h,t.newInstance=u,t.same=d,t.parse=p,t.divide=c,t.str=f,t.getTagName=g,t.match=y,t.hashCode=b,t.styleObj=m,t.style=v,t.addStyle=_,t.css=C,t.cls=w,t.attributes=S,t.ul=x,t.ol=T,t.buildCss=O,t.removeClass=W,t.toggleClass=E,t.setCss=I,t.buildIcon=R,t.build=D,t.addWrapper=k,t.val=A,t.getContainer=L,t.openURL=U}(WUX||(WUX={}))
var WUX
!function(t){function e(t,e,i,n){_showMessage(t,e,i,n)}function i(t,e,i,n){_showInfo(t,e,i,n)}function n(t,e,i){_showSuccess(t,e,i)}function o(t,e,i){_showWarning(t,e,i)}function r(t,e,i){_showError(t,e,i)}function s(t,e){_confirm(t,e)}function a(t,e,i){_getInput(t,e,i)}function l(){return $("#ptitle")}function h(){return $("#pbreadcrumb")}function u(){return $("#pheader")}function d(){return $("#pfooter")}function p(){return $("#side-menu")}function c(){return $("#view-root")}function f(t){if(!$.b2xSticky)return void console.error("b2xSticky not loaded.")
$.b2xSticky()}function g(){$.b2xStickyRefresh()}function y(e,i,n){if(void 0===i&&(i=!1),void 0===n&&(n=!1),!e)return""
...
if("number"==typeof t){if(e){var i=Math.floor(t/1e4),n=Math.floor(t%1e4/100),o=t%1e4%100,r=n<10?"0"+n:""+n,s=o<10?"0"+o:""+o
return i+":"+r+":"+s}var i=Math.floor(t/100),n=t%100,r=n<10?"0"+n:""+n
return i+":"+r}if("string"==typeof t)return t.indexOf(":")>0?t:t.length<3?t+":00":t.length>=5?t.substring(0,2)+":"+t.substring(2,4)+":"+t.substring(4):t.substring(0,2)+":"+t.substring(2)
...
return a+":"+l+":"+s}return a+":"+l}return""}function v(e,i,n,o){if(""===e||null==e)return""
...
return null!=i&&0!=r?null!=o&&r<0?"l"==o?r.toLocaleString("it-IT"):o.replace("$",s):"l"==i?r.toLocaleString("it-IT"):i.replace("$",s):null!=n&&0==r?n.replace("$",s):s}function C(e,i,n,o){if(""===e||null==e)return""
var r=t.WUtil.toNumber(e),s=(Math.round(100*r)/100).toLocaleString("it-IT"),a=s.indexOf(",")
return a<0&&(s+=",00"),a==s.length-2&&(s+="0"),null!=i&&0!=r?null!=o&&r<0?o.replace("$",s):i.replace("$",s):null!=n&&0==r?n.replace("$",s):s}function w(e,i,n,o){if(""===e||null==e)return""
...
s=u+h}return null!=i&&0!=r?null!=o&&r<0?o.replace("$",s):i.replace("$",s):null!=n&&0==r?n.replace("$",s):s}function S(t){return null==t?"":t?"S":"N"}function x(e){if(null==e)return""
...
case 12:return e?"Dicembre"+i:"Dic"+i}return""}function W(e){if(!e)return 0
...
return n>0&&n<13?n:0}function E(t){return t?(t=""+t,t=t.replace("À","A'").replace("È","E'").replace("Ì","I'").replace("Ò","O'").replace("Ù","U'"),t=t.replace("à","a'").replace("è","e'").replace("ì","i'").replace("ò","o'").replace("ù","u'"),t=t.replace("á","a`").replace("é","e`").replace("í","i`").replace("ó","o`").replace("ú","u`"),t=t.replace("€","E").replace("ª","a").replace("°","o")):""}function I(t){return t?(t=""+t,t=t.replace("A'","À").replace("E'","È").replace("I'","Ì").replace("O'","Ò").replace("U'","Ù"),t=t.replace("a'","à").replace("e'","è").replace("i'","ì").replace("o'","ò").replace("u'","ù"),t=t.replace("a`","á").replace("e`","é").replace("i`","í").replace("o`","ó").replace("u`","ú"),t=t.replace(" pò"," po'")):""}function R(t){return t?(t=""+t,t=t.replace("&Agrave;","A'").replace("&Egrave;","E'").replace("&Igrave;","I'").replace("&Ograve;","O'").replace("&Ugrave;","U'"),t=t.replace("&agrave;","a'").replace("&egrave;","e'").replace("&igrave;","i'").replace("&ograve;","o'").replace("&ugrave;","u'"),t=t.replace("&aacute;","a`").replace("&eacute;","e`").replace("&iacute;","i`").replace("&oacute;","o`").replace("&uacute;","u`"),t=t.replace("&euro;","E").replace("&nbsp;"," ").replace("&amp;","&").replace("&gt;",">").replace("&lt;","<").replace("&quot;",'"')):""}function D(t){if(!t)return""
for(var e=""+t,i="",n=0,o=0;o<e.length;o++){n=n>=U.length-1?0:n+1
var r=e.charCodeAt(o),s=U.charCodeAt(n),a=r
r>=32&&r<=126&&(a-=s)<32&&(a=127+a-32),i+=String.fromCharCode(a)}return i}function k(t){if(!t)return""
for(var e=""+t,i="",n=0,o=0;o<e.length;o++){n=n>=U.length-1?0:n+1
var r=e.charCodeAt(o),s=U.charCodeAt(n),a=r
r>=32&&r<=126&&(a+=s)>126&&(a=31+a-126),i+=String.fromCharCode(a)}return i}var A={},L={}
t.global={locale:"it",main_class:"container-fluid",con_class:"container",box_class:"ibox",box_header:"ibox-title",box_title:"<h5>$</h5>",box_tools:"ibox-tools",box_content:"ibox-content",box_footer:"ibox-footer",chart_bg0:"rgba(26,179,148,0.5)",chart_bg1:"rgba(220,220,220,0.5)",chart_bg2:"rgba(160,220,255,0.5)",chart_bc0:"rgba(26,179,148,0.7)",chart_bc1:"rgba(220,220,220,0.7)",chart_bc2:"rgba(160,220,255,0.7)",chart_p0:"rgba(26,179,148,1)",chart_p1:"rgba(220,220,220,1)",chart_p2:"rgba(160,220,255,1)",area:{b:"-radius:8px",m:"0px 0px 0px 0px",p:"16px 7px 5px 7px",bg:"white"},area_title:{b:"none",f:14,fw:"bold",w:"unset",ps:"relative",t:12,l:0,m:0},section:{b:"#e7eaec",m:"2px 0px 4px 0px",p:"8px 8px 8px 8px",bg:"#fafafa"},section_title:{b:"none",f:16,fw:"600",w:"unset",m:"-bottom:2px",tt:"uppercase"},window_top:{ps:"fixed",t:0,bg:"#ffffff",ml:-10,p:"0 10px",z:1001},window_bottom:{ps:"fixed",bt:0,bg:"#ffffff",ml:-10,p:"0 10px",z:1001},init:function(e){t.debug&&console.log("[WUX] global.init..."),$.when($.getJSON("cldr/ca-gregorian.json"),$.getJSON("cldr/numbers.json"),$.getJSON("cldr/currencies.json"),$.getJSON("cldr/timeZoneNames.json"),$.getJSON("cldr/supplemental/likelySubtags.json"),$.getJSON("cldr/supplemental/timeData.json"),$.getJSON("cldr/supplemental/weekData.json"),$.getJSON("cldr/supplemental/currencyData.json"),$.getJSON("cldr/supplemental/numberingSystems.json"),$.getJSON("cldr/supplemental/plurals.json"),$.getJSON("cldr/supplemental/ordinals.json")).then(function(){return[].slice.apply(arguments,[0]).map(function(t){return t[0]})}).then(Globalize.load).then(function(){Globalize.locale(t.global.locale),DevExpress.localization.locale(t.global.locale),DevExpress.config({defaultCurrency:"EUR"}),t.debug&&console.log("[WUX] global.init completed"),e&&e()}).fail(function(){t.debug&&console.log("[WUX] global.init failed")})},setData:function(t,e,i){if(void 0===i&&(i=!1),t||(t="global"),A[t]=e,!i&&L[t])for(var n=0,o=L[t];n<o.length;n++){var r=o[n]
r(e)}},getData:function(t,e){t||(t="global")
var i=A[t]
return null==i?e:i},onDataChanged:function(t,e){t||(t="global"),L[t]||(L[t]=[]),L[t].push(e)}},t.showMessage=e,t.showInfo=i,t.showSuccess=n,t.showWarning=o,t.showError=r,t.confirm=s,t.getInput=a,t.getPageTitle=l,t.getBreadcrump=h,t.getPageHeader=u,t.getPageFooter=d,t.getPageMenu=p,t.getViewRoot=c,t.sticky=f,t.stickyRefresh=g,t.formatDate=y,t.formatDateTime=b,t.formatTime=m,t.formatNum2=v,t.formatNum=_,t.formatCurr=C,t.formatCurr5=w,t.formatBoolean=S,t.format=x,t.formatDay=T,t.formatMonth=O,t.decodeMonth=W,t.norm=E,t.den=I,t.text=R
var U="@D:=E?('B;F)<=A>C@?):D';@=B<?C;)E:'@=?A(B<=;(?@>E:"
t.encrypt=D,t.decrypt=k
...
var N=function(){function t(){}return t.STICKY_CONTAINER="data-b2x-sticky-container",t.STICKY_ELEMENT='data-b2x-sticky-element data-b2x-sticky-element-z-index="3"',t.BOX_FILTER='data-b2x-sticky-element data-b2x-sticky-element-ignore-margin-bottom="true" data-b2x-sticky-element-z-index="3"',t}()
t.ATT=N
...
var F=function(){function t(){}return t.OK="OK",t.CLOSE="Chiudi",t.CANCEL="Annulla",t.ERR_DATE="Data non ammessa.",t}()
t.RES=F}(WUX||(WUX={}))
var WUX
...
this.root.find("tbody tr:eq("+n+")").addClass("success")}if(!this.handlers._selectionchanged)return this
for(var o=0,r=this.handlers._selectionchanged;o<r.length;o++){(0,r[o])({element:this.root,selectedRowsData:[]})}return this},i.prototype.selectAll=function(t){if(!this.mounted)return this
if(this.root.find("tbody tr").addClass("success"),!this.handlers._selectionchanged)return this
for(var e=0,i=this.handlers._selectionchanged;e<i.length;e++){(0,i[e])({element:this.root,selectedRowsData:[]})}return this},i.prototype.getSelectedRows=function(){return this.mounted?this.selectedRow<0?[]:[this.selectedRow]:[]},i.prototype.getSelectedRowsData=function(){return this.mounted?this.selectedRow<0?[]:this.state&&this.state.length?this.state.length<=this.selectedRow?[]:this.state[this.selectedRow]:[]:[]},i.prototype.getFilteredRowsData=function(){return this.state},i.prototype.refresh=function(){return this},i.prototype.getCellValue=function(e,i){if(e<0||i<0)return null
...
var i=this.style?' style="'+this.style+'"':"",n='<div class="table-responsive"><table id="'+this.id+'" class="'+e+'"'+i+">"
...
if(_){var C=$("<td"+t.buildCss(m,y,{w:v})+"></td>")
_(C,{data:r,text:g}),s.append(C)}else if(t.WUtil.hasComponents(g))for(var w=t.WUtil.toArrayComponent(g),S=0,x=w;S<x.length;S++){var T=x[S],C=$("<td"+t.buildCss(m,y,{w:v})+"></td>")
s.append(C),T.mount(C)}else this.boldNonZero&&0!=g&&"0"!=g&&""!=g?s.append($("<td"+t.buildCss(m,y,{w:v})+"><strong>"+g+"</strong></td>")):s.append($("<td"+t.buildCss(m,y,{w:v})+">"+g+"</td>"))}if(this.header&&this.header.length>this.keys.length)for(var O=0;O<this.header.length-this.keys.length;O++)s.append($("<td"+t.buildCss(this.colStyle)+"></td>"))}},i}(t.WComponent)
t.WTable=f
...
return this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Radio,component:o}),this},i.prototype.addPasswordField=function(e,i,n){return this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Password,readonly:n}),this},i.prototype.addEmailField=function(e,i,n){return this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Email,readonly:n}),this},i.prototype.addFtpField=function(e,i,n){return this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Ftp,readonly:n}),this},i.prototype.addCronField=function(e,i,n,o){return this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Cron,readonly:n,value:o}),this},i.prototype.addComponent=function(e,i,n,o){if(n)return e?(n.id=this.subId(e),this.currRow.push({id:this.subId(e),label:i,type:t.WInputType.Component,component:n,readonly:o}),n instanceof t.WInput&&(n.classStyle||(n.classStyle=t.CSS.FORM_CTRL))):(n.id="",this.currRow.push({id:"",label:i,type:t.WInputType.Component,component:n,readonly:o})),this.components.push(n),this},i.prototype.addCaption=function(e,i,n,o){if(e){var r=new t.WLabel("",e,i,n,o)
...
f.append(w),C.mount(w)}}switch(d.type){case t.WInputType.Blank:d.element=$(t.build("div",d.placeholder,d.style,d.attributes,d.id,d.classStyle))
break
case t.WInputType.Text:var S='<input type="text" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(S+="readonly "),0==d.enabled&&(S+="disabled "),d.style&&(S+=' style="'+t.style(d.style)+'"'),S+="/>",d.element=$(S)
break
case t.WInputType.Note:var x='<textarea name="'+d.id+'" id="'+d.id+'" class="form-control" '
d.attributes&&(x+=d.attributes+" "),d.readonly&&(x+="readonly "),0==d.enabled&&(x+="disabled "),d.style&&(x+=' style="'+t.style(d.style)+'"'),x+="></textarea>",d.element=$(x)
break
...
break
case t.WInputType.CheckBox:d.element=$('<input type="checkbox" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" style="height:16px" />')
break
case t.WInputType.Radio:d.component&&d.component.mount(f)
break
case t.WInputType.Select:var O=""
if(d.attributes?(O+='<select name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '+d.attributes,(d.readonly||0==d.enabled)&&(O+=" disabled"),O+=">"):(O+='<select name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'"',(d.readonly||0==d.enabled)&&(O+="disabled"),O+=">"),d.options&&d.options.length>0)for(var W=0;W<d.options.length;W++){var E=d.options[W]
O+="string"==typeof E?"<option>"+E+"</option>":'<option value="'+E.id+'">'+E.text+"</option>"}O+="</select>",d.element=$(O)
break
case t.WInputType.Email:var I='<input type="text" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(I+="readonly "),0==d.enabled&&(I+="disabled "),d.style&&(I+=' style="'+t.style(d.style)+'"'),I+="/>",d.element=$(I)
break
case t.WInputType.Ftp:var R='<input type="text" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(R+="readonly "),0==d.enabled&&(R+="disabled "),d.style&&(R+=' style="'+t.style(d.style)+'"'),R+="/>",d.element=$(R)
break
case t.WInputType.Password:var D='<input type="password" name="'+d.id+'" id="'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(D+="readonly "),0==d.enabled&&(D+="disabled "),d.style&&(D+=' style="'+t.style(d.style)+'"'),D+="/>",d.element=$(D)
break
case t.WInputType.Cron:var k=""
null!=d.value&&""!=d.value&&(k='initial: "'+d.value+'" ,')
var A='<div id="cron_'+d.id+'" class="'+this.inputClass+'" '
d.readonly&&(A+="readonly "),0==d.enabled&&(A+="disabled "),A+=" ></div>",A+='<script type="text/javascript">$(document).ready(function() {',A+='$("#cron_'+d.id+'").cron({'+k+'onChange: function() {$("#'+d.id+'").val($(this).cron("value"));},useGentleSelect: true});',A+='});<\/script><input type="hidden" name="'+d.id+'" id="'+d.id+'" />',d.element=$(A)
break
...
this.root.append(F)
var P=$('<div class="'+this.footerClass+'"'+N+"></div>")
F.append(P)
for(var H=0,V=this.footer;H<V.length;H++){var G=V[H]
"string"==typeof G&&G.length>0?P.append($(G)):G instanceof t.WComponent?G.mount(P):P.append(G)}}for(var B=this,j=0,K=this.dpids;j<K.length;j++){var X=K[j]
!function(i){var n=t.WUtil.getDate(B.minValues,i)
$("#"+i).datepicker({language:"it",todayBtn:"linked",keyboardNavigation:!1,forceParse:!1,calendarWeeks:!0,autoclose:!0,minDate:n}).on("changeDate",function(n){if(e.handlers._changedate)for(var o=0,r=e.handlers._changedate;o<r.length;o++){var s=r[o]
...
p>=19000101&&u>p&&(t.showWarning(t.RES.ERR_DATE),$(n.target).datepicker("setDate",l))}}}})}(X)}"object"==typeof this.state&&this.updateView(),this.root.find("input").keypress(function(t){if(13==t.which){for(var i=$(t.target).attr("id"),n=e.next(i);n&&!e.isFocusable(n);)n=e.next(n.id)
...
break
default:r.value=""}}return this},i.prototype.select=function(t,e){if(!t)return this
...
break
case t.WInputType.Ftp:h=new RegExp(/(((ftp:(?:\/\/)?)(?:[\-;:&=\+\$,\w]+@)?[A-Za-z0-9\.\-]+|(?:www\.|[\-;:&=\+\$,\w]+@)[A-Za-z0-9\.\-]+)((?:\/[\+~%\/\.\w\-_]*)?\??(?:[\-\+=&;%@\.\w_]*)#?(?:[\.\!\/\\\w]*))?)/),h.test(e[a])||(l="Campo "+r.label+": valore non idoneo ("+e[a]+" non risulta URL FTP)")}if(null!=l)throw new Error(l)}}return e},i}(t.WComponent)
t.WFormPanel=g
...
o>=0&&i.push(o)}this.groupsCols.push(i)}else this.groupsCols.push(e)}},i.prototype.onClickAction=function(t){this.handlers._clickaction||(this.handlers._clickaction=[]),this.handlers._clickaction.push(t)},i.prototype.onSelectionChanged=function(t){if(this.handlers._selectionchanged=[],this.handlers._selectionchanged.push(t),this.mounted){var e={onSelectionChanged:t}
this.root.dxDataGrid(e)}},i.prototype.onDoubleClick=function(t){this.handlers._doubleclick||(this.handlers._doubleclick=[]),this.handlers._doubleclick.push(t)},i.prototype.onSelectAll=function(t){this.handlers._selectall||(this.handlers._selectall=[]),this.handlers._selectall.push(t)},i.prototype.onDoneRefresh=function(t){this.handlers._donerefresh||(this.handlers._donerefresh=[]),this.handlers._donerefresh.push(t)},i.prototype.onRowPrepared=function(t){if(this.handlers._rowprepared=[],this.handlers._rowprepared.push(t),this.mounted){var e={onRowPrepared:t}
this.root.dxDataGrid(e)}},i.prototype.onCellPrepared=function(t){if(this.handlers._cellprepared=[],this.handlers._cellprepared.push(t),this.mounted){var e={onCellPrepared:t}
this.root.dxDataGrid(e)}},i.prototype.onContentReady=function(t){if(this.handlers._contentready=[],this.handlers._contentready.push(t),this.mounted){var e={onContentReady:t}
this.root.dxDataGrid(e)}},i.prototype.onRowUpdated=function(t){if(this.handlers._rowupdated=[],this.handlers._rowupdated.push(t),this.mounted){var e={onRowUpdated:t}
this.root.dxDataGrid(e)}},i.prototype.onEditorPreparing=function(t){if(this.handlers._editorpreparing=[],this.handlers._editorpreparing.push(t),this.mounted){var e={onEditorPreparing:t}
this.root.dxDataGrid(e)}},i.prototype.onEditorPrepared=function(t){if(this.handlers._editorprepared=[],this.handlers._editorprepared.push(t),this.mounted){var e={onEditorPrepared:t}
this.root.dxDataGrid(e)}},i.prototype.onEditingStart=function(t){if(this.handlers._editingstart=[],this.handlers._editingstart.push(t),this.mounted){var e={onEditingStart:t}
this.root.dxDataGrid(e)}},i.prototype.onCellClick=function(t){if(this.handlers._cellclick=[],this.handlers._cellclick.push(t),this.mounted){var e={onCellClick:t}
this.root.dxDataGrid(e)}},i.prototype.onScroll=function(t){this.handlers._scroll=[],this.handlers._scroll.push(t),this.mounted&&this.root.dxDataGrid("instance").getScrollable().on("scroll",t)},i.prototype.onKeyDown=function(t){if(this.handlers._keydown=[],this.handlers._keydown.push(t),this.mounted){var e={onKeyDown:t}
this.root.dxDataGrid(e)}},i.prototype.scrollTo=function(t){this.mounted&&this.root.dxDataGrid("instance").getScrollable().scrollTo(t)},i.prototype.clearFilter=function(){this.mounted&&this.state&&this.root.dxDataGrid("instance").clearFilter()},i.prototype.off=function(t){if(e.prototype.off.call(this,t),!t)return this
var i={}
return t.indexOf("_selectionchanged")>=0&&(i.onSelectionChanged=null),t.indexOf("_rowprepared")>=0&&(i.onRowPrepared=null),t.indexOf("_cellprepared")>=0&&(i.onCellPrepared=null),t.indexOf("_contentready")>=0&&(i.onContentReady=null),t.indexOf("_rowupdated")>=0&&(i.onRowUpdated=null),t.indexOf("_editorprepared")>=0&&(i.onEditorPrepared=null),t.indexOf("_editorpreparing")>=0&&(i.onEditorPreparing=null),t.indexOf("_editingstart")>=0&&(i.onEditingStart=null),t.indexOf("_cellclick")>=0&&(i.onCellClick=null),t.indexOf("_keydown")>=0&&(i.onKeyDown=null),this.root.dxDataGrid(i),this},i.prototype.clearSelection=function(){return this.mounted&&this.state?(this.root.dxDataGrid("instance").clearSelection(),this):this},i.prototype.deselectAll=function(){return this.mounted?(this.root.dxDataGrid("instance").deselectAll(),this):this},i.prototype.select=function(t){return this.mounted?(this.root.dxDataGrid("instance").selectRowsByIndexes(t),this):this},i.prototype.selectRows=function(t,e){return this.mounted?(this.root.dxDataGrid("instance").selectRows(t,e),this):this},i.prototype.deselectRows=function(t){return this.mounted?(this.root.dxDataGrid("instance").deselectRows(t),this):this},i.prototype.selectAll=function(e){if(!this.mounted)return this
...
return""+r[1]+r[2]}}else if("string"==typeof r&&e==r&&n>2)return""+i[1]+i[2]}return""},i.prototype.getInstance=function(){return this.mounted?this.root.dxDataGrid("instance"):null},i.prototype.getSelectedKeys=function(){return this.mounted?this.root.dxDataGrid("instance").getSelectedRowKeys():[]},i.prototype.getSelectedRows=function(){if(!this.mounted)return[]
...
for(var o=0,r=e.handlers._doubleclick;o<r.length;o++){(0,r[o])({element:e.root,data:t.data})}}},this.selectionMode&&"none"!=this.selectionMode&&(this.selectionFilter&&this.selectionFilter.length?i.selection={mode:this.selectionMode,deferred:!0}:i.selection={mode:this.selectionMode}),this.selectionFilter&&this.selectionFilter.length&&(i.selectionFilter=this.selectionFilter),this.exportFile&&(i.export={enabled:!0,fileName:this.exportFile}),this.handlers._selectionchanged&&this.handlers._selectionchanged.length&&(i.onSelectionChanged=this.handlers._selectionchanged[0]),this.handlers._rowprepared&&this.handlers._rowprepared.length&&(i.onRowPrepared=this.handlers._rowprepared[0]),this.handlers._cellprepared&&this.handlers._cellprepared.length&&(i.onCellPrepared=this.handlers._cellprepared[0]),this.handlers._contentready&&this.handlers._contentready.length&&(i.onContentReady=this.handlers._contentready[0]),this.handlers._rowupdated&&this.handlers._rowupdated.length&&(i.onRowUpdated=this.handlers._rowupdated[0]),this.handlers._cellclick&&this.handlers._cellclick.length&&(i.onCellClick=this.handlers._cellclick[0]),this.handlers._editorprepared&&this.handlers._editorprepared.length&&(i.onEditorPrepared=this.handlers._editorprepared[0]),this.handlers._editorpreparing&&this.handlers._editorpreparing.length&&(i.onEditorPreparing=this.handlers._editorpreparing[0]),this.handlers._editingstart&&this.handlers._editingstart.length&&(i.onEditingStart=this.handlers._editingstart[0]),this.handlers._keydown&&this.handlers._keydown.length&&(i.onKeyDown=this.handlers._keydown[0]),this.beforeInit(i),this.root.dxDataGrid(i),this.handlers._scroll&&this.handlers._scroll.length&&this.root.dxDataGrid("instance").getScrollable().on("scroll",this.handlers._scroll[0])},i.prototype.componentWillUpdate=function(t,e){var i=this
e||(e=[]),this.editmap={}
var n
...
if("number"!=typeof e[0]){for(var i=[],n=0;n<e.length;n++){var o=this.keys.indexOf(e[n])
o>=0&&i.push(o)}this.groupsCols.push(i)}else this.groupsCols.push(e)}},i.prototype.onClickAction=function(t){this.handlers._clickaction||(this.handlers._clickaction=[]),this.handlers._clickaction.push(t)},i.prototype.onSelectionChanged=function(t){if(this.handlers._selectionchanged=[],this.handlers._selectionchanged.push(t),this.mounted){var e={onSelectionChanged:t}
this.root.dxTreeList(e)}},i.prototype.onDoubleClick=function(t){this.handlers._doubleclick||(this.handlers._doubleclick=[]),this.handlers._doubleclick.push(t)},i.prototype.onRowPrepared=function(t){if(this.handlers._rowprepared=[],this.handlers._rowprepared.push(t),this.mounted){var e={onRowPrepared:t}
this.root.dxTreeList(e)}},i.prototype.onCellPrepared=function(t){if(this.handlers._cellprepared=[],this.handlers._cellprepared.push(t),this.mounted){var e={onCellPrepared:t}
this.root.dxTreeList(e)}},i.prototype.onContentReady=function(t){if(this.handlers._contentready=[],this.handlers._contentready.push(t),this.mounted){var e={onContentReady:t}
this.root.dxTreeList(e)}},i.prototype.onRowUpdated=function(t){if(this.handlers._rowupdated=[],this.handlers._rowupdated.push(t),this.mounted){var e={onRowUpdated:t}
this.root.dxTreeList(e)}},i.prototype.onEditorPreparing=function(t){if(this.handlers._editorpreparing=[],this.handlers._editorpreparing.push(t),this.mounted){var e={onEditorPreparing:t}
this.root.dxTreeList(e)}},i.prototype.onEditorPrepared=function(t){if(this.handlers._editorprepared=[],this.handlers._editorprepared.push(t),this.mounted){var e={onEditorPrepared:t}
this.root.dxTreeList(e)}},i.prototype.onEditingStart=function(t){if(this.handlers._editingstart=[],this.handlers._editingstart.push(t),this.mounted){var e={onEditingStart:t}
this.root.dxTreeList(e)}},i.prototype.onCellClick=function(t){if(this.handlers._cellclick=[],this.handlers._cellclick.push(t),this.mounted){var e={onCellClick:t}
this.root.dxTreeList(e)}},i.prototype.onScroll=function(t){if(this.handlers._scroll=[],this.handlers._scroll.push(t),this.mounted){var e=this.root.dxTreeList("instance")
e&&e.getScrollable().on("scroll",t)}},i.prototype.onKeyDown=function(t){if(this.handlers._keydown=[],this.handlers._keydown.push(t),this.mounted){var e={onKeyDown:t}
...
var i={}
return t.indexOf("_selectionchanged")>=0&&(i.onSelectionChanged=null),t.indexOf("_rowprepared")>=0&&(i.onRowPrepared=null),t.indexOf("_cellprepared")>=0&&(i.onCellPrepared=null),t.indexOf("_contentready")>=0&&(i.onContentReady=null),t.indexOf("_rowupdated")>=0&&(i.onRowUpdated=null),t.indexOf("_editorprepared")>=0&&(i.onEditorPrepared=null),t.indexOf("_editorpreparing")>=0&&(i.onEditorPreparing=null),t.indexOf("_editingstart")>=0&&(i.onEditingStart=null),t.indexOf("_cellclick")>=0&&(i.onCellClick=null),t.indexOf("_keydown")>=0&&(i.onKeyDown=null),this.root.dxTreeList(i),this},i.prototype.clearSelection=function(){return this.mounted&&this.state?(this.root.dxTreeList("instance").clearSelection(),this):this},i.prototype.deselectAll=function(){return this.mounted?(this.root.dxTreeList("instance").deselectAll(),this):this},i.prototype.select=function(t){return this.mounted?(this.root.dxTreeList("instance").selectRowsByIndexes(t),this):this},i.prototype.selectAll=function(e){if(!this.mounted)return this
if(e){var i=t.WUtil.size(this.getSelectedRows()),n=t.WUtil.size(this.state)
...
if(Array.isArray(r)){if(r.length>2){if(e!=r[0])continue
return""+r[1]+r[2]}}else if("string"==typeof r&&e==r&&n>2)return""+i[1]+i[2]}return""},i.prototype.getInstance=function(){return this.mounted?this.root.dxTreeList("instance"):null},i.prototype.getSelectedRows=function(){if(!this.mounted)return[]
...
if(i&&n.getTime()-i.getTime()<300){if(!e.handlers._doubleclick)return
for(var o=0,r=e.handlers._doubleclick;o<r.length;o++){(0,r[o])({element:e.root,data:t.data})}}},this.selectionMode&&"none"!=this.selectionMode&&(i.selection={mode:this.selectionMode}),this.handlers._selectionchanged&&this.handlers._selectionchanged.length&&(i.onSelectionChanged=this.handlers._selectionchanged[0]),this.handlers._rowprepared&&this.handlers._rowprepared.length&&(i.onRowPrepared=this.handlers._rowprepared[0]),this.handlers._cellprepared&&this.handlers._cellprepared.length&&(i.onCellPrepared=this.handlers._cellprepared[0]),this.handlers._contentready&&this.handlers._contentready.length&&(i.onContentReady=this.handlers._contentready[0]),this.handlers._rowupdated&&this.handlers._rowupdated.length&&(i.onRowUpdated=this.handlers._rowupdated[0]),this.handlers._cellclick&&this.handlers._cellclick.length&&(i.onCellClick=this.handlers._cellclick[0]),this.handlers._editorprepared&&this.handlers._editorprepared.length&&(i.onEditorPrepared=this.handlers._editorprepared[0]),this.handlers._editorpreparing&&this.handlers._editorpreparing.length&&(i.onEditorPreparing=this.handlers._editorpreparing[0]),this.handlers._editingstart&&this.handlers._editingstart.length&&(i.onEditingStart=this.handlers._editingstart[0]),this.handlers._keydown&&this.handlers._keydown.length&&(i.onKeyDown=this.handlers._keydown[0]),this.beforeInit(i),this.root.dxTreeList(i),this.handlers._scroll&&this.handlers._scroll.length&&this.root.dxTreeList("instance").getScrollable().on("scroll",this.handlers._scroll[0])},i.prototype.componentWillUpdate=function(t,e){e||(e=[]),this.editmap={}
...
a+="<span>"+t.buildIcon(t.WIcon.FILE_O)+" &nbsp;<strong>"+t.TXT.NAME+"</strong>: "+r.name+" &nbsp;",a+="<strong>"+t.TXT.SIZE+"</strong>: "+r.size+" byte &nbsp;",a+="<strong>"+t.TXT.TYPE+"</strong>: "+r.type+" &nbsp;",a+="<strong>"+t.TXT.LAST_MOD+"</strong>: "+t.formatDateTime(s,!0)+"</span>",a+="</div>",e.selectedFiles.append(a)}}}}
...
return this.init(r),this},i.prototype.reload=function(t){return t&&this.setState(null),this.mounted?(this.root.empty(),this.componentDidMount(),this):this},i.prototype.render=function(){return this.multiple?this.buildRoot(this.rootTag,"",'multiple="multiple"',"form-control"):this.buildRoot(this.rootTag,"","","form-control")},i.prototype.updateState=function(t){e.prototype.updateState.call(this,t),this.root&&(Array.isArray(this.state)&&this.state.length>1?(this.root.append('<option value="'+this.state[0]+'">'+this.state[this.state.length-1]+"</option>"),this.root.val(this.state[0]).trigger("change")):this.state?"object"==typeof this.state?(this.root.append('<option value="'+this.state.id+'">'+this.state.text+"</option>"),this.root.val(this.state.id).trigger("change")):this.root.val(this.state).trigger("change"):this.root.val([]).trigger("change"),this.dontTrigger=!0,this.lastChange=(new Date).getTime())},i.prototype.componentDidMount=function(){if(this._tooltip&&this.root.attr("title",this._tooltip),this.options)for(var e=0,i=this.options;e<i.length;e++){var n=i[e]
...
this.root.select2(e),this.updateState(this.state),e?e.data&&(this.count=t.WUtil.size(e.data)):this.count=0,this._init||(this.$cb=this.root.parent().find('span[role="combobox"]').first(),this.$cb.length?this.$cb.on("focus",function(t){if(null!=t.relatedTarget)return i.dontOpen?void(i.dontOpen=!1):void(i.openOnFocus&&setTimeout(function(){if(i.multiple){if(i.$cb&&i.$cb.length){var t=i.$cb.find("input.select2-search__field").first()
...
var o=new(r.bind.apply(r,__spreadArrays([void 0,this.grid,this,this.cols.length,t,e,"",""],i)))
...
return(i=this.row()).addCol.apply(i,__spreadArrays([t,e],n))},i.prototype.add=function(t){return t?this.col().add(t):this.col()},i.prototype.y=function(){return this.col().y()},i.prototype.tip=function(){for(var t,e=[],i=0;i<arguments.length;i++)e[i]=arguments[i]
...
t.WMenu=u}(WUX||(WUX={}))
var WUX
!function(t){var e=function(){function t(){}return t.OK="OK",t.CLOSE="Chiudi",t.NEW="Nuovo",t.OPEN="Modifica",t.DELETE="Elimina",t.SAVE="Salva",t.SEND="Invia",t.SEND_EMAIL="Email",t.FIND="Cerca",t.FORCE="Forza",t.SEARCH="Cerca",t.CANCEL="Annulla",t.RESET="Annulla",t.PRINT="Stampa",t.PRINT_ALL="Stampa Tutto",t.PREVIEW="Anteprima",t.EXPORT="Esporta",t.IMPORT="Importa",t.HELP="Guida",t.VIEW="Vedi",t.ENABLE="Abilita",t.DISABLE="Disabilita",t.ADD="Aggiungi",t.APPLY="Applica",t.REMOVE="Rimuovi",t.REMOVE_ALL="Rim.Tutto",t.REFRESH="Aggiorna",t.UNDO="Annulla",t.SETTINGS="Impostazioni",t.COPY="Copia",t.CUT="Taglia",t.PASTE="Incolla",t.CONFIRM="Conferma",t.FORWARD="Avanti",t.BACKWARD="Indietro",t.NEXT="Prossimo",t.PREVIOUS="Precedente",t.SELECT="Seleziona",t.SELECT_ALL="Sel.Tutto",t.WORK="Lavora",t.AGGREGATE="Aggrega",t.SET="Imposta",t.DEFAULT="Predefinito",t.REWORK="Rielabora",t.PUSH="Spedisci",t.SUSPEND="Sospendi",t.RESUME="Riattiva",t.CODE="Codice",t.DESCRIPTION="Descrizione",t.GROUP="Gruppo",t.ROLE="Ruolo",t.TYPE="Tipo",t.NAME="Nome",t.SIZE="Dim.",t.LAST_MOD="Agg.",t}()
t.TXT=e
var i=function(){function t(){}return t.CONF_DELETE="Eliminare l'elemento selezionato?",t.CONF_DISABLE="Disabilitare l'elemento selezionato?",t.CONF_ENABLE="Abilitare l'elemento selezionato?",t.CONF_CANCEL="Si vogliono annullare le modifiche apportate?",t.CONF_PROCEED="Si vuole procedere con l'operazione?",t.CONF_OVERWRITE="Si vuole procedere con la sovrascrittura?",t.INVALID_DATE="Data non ammessa.",t.INVALID_VALUE="Valore non ammesso.",t.MSG_COMPLETED="Operazione completata con successo.",t.MSG_ERRORS="Errore durante l'elaborazione.",t}()
t.MSG=i
var n=function(){function e(){}return e.TRUE=t.WIcon.CHECK_SQUARE_O,e.FALSE=t.WIcon.SQUARE_O,e.CLOSE=t.WIcon.TIMES,e.OK=t.WIcon.CHECK,e.CALENDAR=t.WIcon.CALENDAR,e.AGGREGATE=t.WIcon.CHAIN,e.NEW=t.WIcon.PLUS_SQUARE_O,e.EDIT=t.WIcon.EDIT,e.OPEN=t.WIcon.EDIT,e.DELETE=t.WIcon.TRASH,e.DETAIL=t.WIcon.FILE_TEXT_O,e.SAVE=t.WIcon.CHECK,e.FIND=t.WIcon.SEARCH,e.FIND_DIFF=t.WIcon.SEARCH_MINUS,e.FIND_PLUS=t.WIcon.SEARCH_PLUS,e.FORCE=t.WIcon.CHECK_CIRCLE,e.FORCE_ALL=t.WIcon.CHECK_CIRCLE_O,e.SEARCH=t.WIcon.SEARCH,e.CANCEL=t.WIcon.UNDO,e.RESET=t.WIcon.TIMES_CIRCLE,e.PRINT=t.WIcon.PRINT,e.PREVIEW=t.WIcon.SEARCH_PLUS,e.EXPORT=t.WIcon.SHARE_SQUARE_O,e.IMPORT=t.WIcon.SIGN_IN,e.FILE=t.WIcon.FILE_O,e.HELP=t.WIcon.QUESTION_CIRCLE,e.VIEW=t.WIcon.FILE_TEXT_O,e.ENABLE=t.WIcon.THUMBS_O_UP,e.DISABLE=t.WIcon.THUMBS_O_DOWN,e.ADD=t.WIcon.PLUS,e.APPLY=t.WIcon.CHECK,e.REMOVE=t.WIcon.MINUS,e.REFRESH=t.WIcon.REFRESH,e.UNDO=t.WIcon.UNDO,e.SETTINGS=t.WIcon.COG,e.OPTIONS=t.WIcon.CHECK_SQUARE,e.PASSWORD=t.WIcon.UNDO,e.COPY=t.WIcon.COPY,e.CUT=t.WIcon.CUT,e.PASTE=t.WIcon.PASTE,e.FORWARD=t.WIcon.ANGLE_DOUBLE_RIGHT,e.BACKWARD=t.WIcon.ANGLE_DOUBLE_LEFT,e.NEXT=t.WIcon.FORWARD,e.PREVIOUS=t.WIcon.BACKWARD,e.CONFIRM=t.WIcon.CHECK,e.FILTER=t.WIcon.FILTER,e.SEND=t.WIcon.SEND,e.SEND_EMAIL=t.WIcon.ENVELOPE_O,e.WAIT=t.WIcon.COG,e.WORK=t.WIcon.COG,e.CONFIG=t.WIcon.COG,e.LEFT=t.WIcon.ARROW_CIRCLE_LEFT,e.RIGHT=t.WIcon.ARROW_CIRCLE_RIGHT,e.SELECT_ALL=t.WIcon.TH_LIST,e.REWORK=t.WIcon.REFRESH,e.PUSH=t.WIcon.TRUCK,e.AHEAD=t.WIcon.ANGLE_DOUBLE_RIGHT,e.SUSPEND=t.WIcon.TOGGLE_OFF,e.RESUME=t.WIcon.RECYCLE,e.PAIRING=t.WIcon.RANDOM,e.CHECK=t.WIcon.CHECK_SQUARE_O,e.EVENT=t.WIcon.BOLT,e.MESSAGE=t.WIcon.ENVELOPE_O,e.USER=t.WIcon.USER_O,e.GROUP=t.WIcon.USERS,e.TOOL=t.WIcon.WRENCH,e.DEMOGRAPHIC=t.WIcon.ADDRESS_CARD,e.DOCUMENT=t.WIcon.FILE_TEXT_O,e.LINKS=t.WIcon.CHAIN,e.WARNING=t.WIcon.WARNING,e.INFO=t.WIcon.INFO_CIRCLE,e.CRITICAL=t.WIcon.TIMES_CIRCLE,e}()
t.ICO=n}(WUX||(WUX={}))
