...
jQuery.validator.addMethod("pwd",function(val,ele){
	...
	return true;
},'Enter valid password (len=8, at least one 1 let. min, 1 let. cap., 1 num.)');
...
function _confirm(msg,f){
	if(typeof f==='function'){
		swal({title:"Confirm",type:"warning",text:msg,confirmButtonText:"Yes",cancelButtonText:"No",confirmButtonColor:"#dd6b55",showCancelButton:true,closeOnConfirm:true,closeOnCancel:true},f);
	}
	else{
...
function _getInput(msg,f,d) {
	if(typeof f==='function'){
		swal({title:"Input",type:"input",inputValue:d,text:msg,showCancelButton:true},f);
	}
	else {
