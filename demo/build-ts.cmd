...
echo Compile common...
call tsc --noEmitHelpers --declaration --project ./ts/common/tsconfig.json
echo Compile dossier...
call tsc --noEmitHelpers --declaration --project ./ts/dossier/tsconfig.json
...
call minify ./js/common.js
call minify ./js/dossier.js
...
rem call uglifyjs ./js/common.js -c -o ./js/common.min.js
rem call uglifyjs ./js/dossier.js -c -o ./js/dossier.min.js
